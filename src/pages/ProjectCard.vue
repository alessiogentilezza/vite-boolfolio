  ...
  <div class="container d-flex flex-wrap p-0">
    <div v-for="project in projects">
      <div class="card m-3" style="width: 18rem;">
        <div class="card">
          <img v-if="project.cover_image" :src="`${this.store.baseUrl}/storage/${project.cover_image}`" class="card-img-top p-3">
        <img v-else src="public/No_Image_Available-8d923bfe.jpg" class="card-img-top p-3"/>
          ...
          <div class="card-body">
            ...
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
              ...
              <router-link :to="{name: 'single-project', params: {slug: project.slug}}" class="badge rounded-pill text-bg-warning">
